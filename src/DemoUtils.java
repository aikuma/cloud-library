...
public class DemoUtils {
    ...
    public static final String configFile = System.getProperty("user.home") + "/.config";
	...
	return readProps(DemoUtils.configFile);
    }
    ...
    public static boolean writeProps(Properties prop) {
        return writeProps(prop, DemoUtils.configFile);
    }
}
